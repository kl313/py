...
hds = {
    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4951.54 Safari/537.36 Edg/99.0.1210.39',
...
url = 'https://phoenix.ujing.online/api/v1/stores/near?page=1&size=30&lat=30.946448&lont=104.310345&scope=2000&mode=BA h2'  # %f为位置坐标
